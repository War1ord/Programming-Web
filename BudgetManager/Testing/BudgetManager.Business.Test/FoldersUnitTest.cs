...
namespace BudgetManager.Common.Test {
	...
	public class Data {
		...
		public void GetCsvData() {
			var csvFileReader = new CsvFileReader(@"C:\test.csv");
			Assert.IsNotNull(csvFileReader);
			csvFileReader =
				new CsvFileReader(
					@"C:\Users\Warlord\Programming\Projects\BudgetManager\Testing Data\DataImports\Absa Transation History\CHEQUE Account\Absa 2010-09-28 to 2010-11-06.csv");
			Assert.IsNotNull(csvFileReader);
		}
	}
