...
namespace BudgetManager.Extentions
{
	...
	{
		public static ObjectQuery<T> Include1<T>(this ObjectQuery<T> query, Expression<Func<T, object>> selector)
		{
		...
		public static ObjectQuery<T> Include2<T>(this ObjectQuery<T> query, Expression<Func<T, object>> selector)
		{
